...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Project Gambit — Your Personal AI Chess Coach" },
      {
        name: "description",
        content:
          "Upload a game and get a real coaching report powered by Stockfish. Understand your mistakes and get a personalized plan to improve.",
      },
      { name: "author", content: "Project Gambit" },
      { property: "og:title", content: "Project Gambit — Your Personal AI Chess Coach" },
      {
        property: "og:description",
        content:
          "Improve after every game. Stockfish-powered analysis explained like a real coach.",
      },
      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html:
              "try{var t=localStorage.getItem('pg-theme');var d=document.documentElement;if(t==='light'){d.classList.remove('dark')}else{d.classList.add('dark')}}catch(e){}",
          }}
        />
      </head>
      <body>
